...
#define NS_SSD_TYPE_2 SSD_TYPE_ZNS
#define NS_CAPACITY_2 (0)
#define NS_SSD_TYPE_3 SSD_TYPE_KV
#define NS_CAPACITY_3 (0)
...
#define SUPPORTED_SSD_TYPE(type) \
	(NS_SSD_TYPE_0 == SSD_TYPE_##type || NS_SSD_TYPE_1 == SSD_TYPE_##type || NS_SSD_TYPE_2 == SSD_TYPE_##type || NS_SSD_TYPE_3 == SSD_TYPE_##type)
