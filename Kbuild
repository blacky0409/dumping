...
nvmev-$(CONFIG_NVMEVIRT_MI) += ssd_config.o simple_ftl.o ssd.o save_load.o zns_save_load.o check_phfrag.o conv_ftl.o pqueue/pqueue.o zns_ftl.o zns_read_write.o zns_mgmt_send.o zns_mgmt_recv.o channel_model.o kv_ftl.o append_only.o bitmap.o
